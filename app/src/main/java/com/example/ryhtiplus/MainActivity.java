...
public class MainActivity extends AppCompatActivity {
    ...
    public void setAlarm(View view){
        ...
        try {
            ...
            Toast.makeText(MainActivity.this, "Anna minuutit kokonaislukuna", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        isAlarmEnabled.setChecked(true);
        Toast.makeText(MainActivity.this, "Muistutus on asetettu", Toast.LENGTH_SHORT).show();
    }
    ...
    public void cancleAlarm(View view){
        ...
        isAlarmEnabled.setChecked(false);
        Toast.makeText(MainActivity.this, "Muistutus on peruuttu", Toast.LENGTH_SHORT).show();
    }
