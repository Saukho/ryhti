...
public class SetNotifActivity extends MainActivity{
    ...
    public void setAlarm(View view){
        ...
        try {
            ...
            Toast.makeText(SetNotifActivity.this, "Anna minuutit kokonaislukuna", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        isAlarmEnabled.setChecked(true);
        Toast.makeText(SetNotifActivity.this, "Muistutus on asetettu", Toast.LENGTH_SHORT).show();
    }
    ...
    public void cancleAlarm(View view){
        ...
        isAlarmEnabled.setChecked(false);
        Toast.makeText(SetNotifActivity.this, "Muistutus on peruuttu", Toast.LENGTH_SHORT).show();
    }
